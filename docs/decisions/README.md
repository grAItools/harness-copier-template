...
| [0016](0016-filter-shape-probe-guard-selftest-anchored-gate.md) | Filter-shape jq probe, single-document payloads, guard self-test, anchored Stop gate | accepted; Decision 3 amended by 0019 |
| [0017](0017-deny-list-tokenizer-in-python3.md) | The deny-list verdict moves to a python3 tokenizer | accepted |
| [0019](0019-guard-selftest-negative-control.md) | A negative control in the guard self-test | accepted |
